...
int main()
{
	...
	arr2pointLights[0]= PointLight(1.0f, 1.0f, 1.0f,
		1.0f, 1.0f,
		0.0f, 3.0f, 4.0f,
		0.3f, 0.2f, 0.1f);
	pointLightCount++;

	arr2pointLights[1] = PointLight(0.0f, 1.0f, 0.0f,
		1.0f, 1.0f,
		0.0f, 3.0f, 4.0f,
		0.3f, 0.2f, 0.1f);
	pointLightCount++;
	arr2pointLights[2] = PointLight(0.0f, 0.0f, 1.0f,
		1.0f, 1.0f,
		0.0f, 3.0f, 4.0f,
		0.3f, 0.2f, 0.1f);
	pointLightCount++;
	
	arr2pointLights[3] = PointLight(1.0f, 0.0f, 0.0f,
		1.0f, 1.0f,
		0.0f, 3.0f, 4.0f,
		0.3f, 0.2f, 0.1f);
	pointLightCount++;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		mainWindow.getSel_light()? shaderList[0].SetPointLights(pointLights, pointLightCount): shaderList[0].SetPointLights(arr2pointLights, pointLightCount);
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0+mainWindow.getmuevex(), 5.0f, 6.0));
		...
		//cabeza.render();
		spotLights[1].SetPos(glm::vec3(-0.7+ mainWindow.getmuevex(), 5.0, 6.0));
